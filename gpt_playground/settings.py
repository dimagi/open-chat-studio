...
# Connect Messaging
CONNECT_MESSAGING_SERVER_SECRET = env("CONNECT_MESSAGING_SERVER_SECRET", default="")
CONNECT_MESSAGING_SERVER_ID = env("CONNECT_MESSAGING_SERVER_ID", default="")
CONNECT_MESSAGING_ENABLED = CONNECT_MESSAGING_SERVER_SECRET and CONNECT_MESSAGING_SERVER_ID
CONNECT_ID_SERVER_BASE_URL = env("CONNECT_ID_SERVER_BASE_URL", default="https://connectid.dimagi.com")
