...
# AWS Polly
AWS_POLLY_ACCESS_KEY_ID = env("AWS_POLLY_ACCESS_KEY_ID", default="")
AWS_POLLY_SECRET_KEY = env("AWS_POLLY_SECRET_KEY", default="")
AWS_POLLY_REGION = env("AWS_POLLY_REGION", default="ap-south-1")
