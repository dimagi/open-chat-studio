...
We're building toward a development model where AI agents do the bulk of coding and review, and humans provide direction, judgment, and oversight. We're not there yet. Today we use Claude Code for implementation and Claude Code Agents for picking up routine tasks overnight.
