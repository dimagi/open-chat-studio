...
- If you have user-facing code changes, use the AI-assisted docs/changelog automation [(i.e., the changelog process)](../developer_guides/user_docs/index.md).
   - Note: If you are developing on a fork, the automated process to create user docs on a PR will fail, so you have to do this [manually](../developer_guides/user_docs/changelog_automation.md#manual-option) or ask the Dimagi team to [run the GitHub action](../developer_guides/user_docs/changelog_automation.md#manual-trigger-in-docs-repo).
