...
- **Global Admin > Feature Flags** (`/admin/flags/`)
...
- **Team Settings > Manage Feature Flags**
...
- [Testing mode](https://waffle.readthedocs.io/en/stable/testing/user.html#querystring-parameter): activate a flag with a URL parameter.
