...
- **Negative:** No Django plugin support means we must work around Django metaprogramming differently (see [ADR-0008](0008-django-types-stubs-for-ty.md) for the chosen stubs strategy) and live with some unavoidable false positives.
