...
| [0051](0051-store-source-bytes-extract-at-index-time.md) | <span class="adr-status adr-status-accepted">ACCEPTED</span> | Store the bytes a source served; extract text at index time |
