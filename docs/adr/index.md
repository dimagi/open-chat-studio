...
| [0031](0031-email-allowed-domains-three-layer-enforcement.md) | <span class="adr-status adr-status-accepted">ACCEPTED</span> | Enforce email allowed-domains at three layers |
