...
| [0046](0046-deploy-safe-evaluation-runs.md) | <span class="adr-status adr-status-proposed">PROPOSED</span> | Deploy-safe evaluation runs via a beat coordinator over a frozen plan |
