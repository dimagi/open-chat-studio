...
| [0051](0051-pipeline-discovery-is-an-llm-facing-contract.md) | <span class="adr-status adr-status-accepted">ACCEPTED</span> | Pipeline discovery is an LLM-facing contract |
