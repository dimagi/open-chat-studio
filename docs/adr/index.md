...
| [0067](0067-team-actionable-provider-errors-are-configuration-errors.md) | <span class="adr-status adr-status-proposed">PROPOSED</span> | Team-actionable provider errors are configuration errors |
