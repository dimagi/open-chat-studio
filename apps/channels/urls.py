...
urlpatterns = [
    ...
    path("whatsapp/meta/incoming_message", views.MetaCloudAPIWebhookView.as_view(), name="new_meta_cloud_api_message"),
    ...
    path(
        ...
        views.NewApiMessageVersionedView.as_view(),
    ...
    path(
        ...
        views.ChannelEditDialogView.as_view(),
