...
class ChannelPlatform(models.TextChoices):
    ...
    def for_dropdown(cls, used_platforms, team) -> dict[Self, bool]:
        ...
        from apps.service_providers.models import MessagingProvider  # noqa: PLC0415  # circular import
    ...
    def form(self, experiment: Experiment):
        from apps.channels.forms import ChannelForm  # noqa: PLC0415  # circular import

        return ChannelForm(initial={"platform": self}, experiment=experiment)

    def extra_form(self, **kwargs):
        from apps.channels import forms  # noqa: PLC0415  # circular import
...
class ExperimentChannel(BaseTeamModel):
    ...
    def webhook_url(self) -> str:
        ...
        from apps.service_providers.models import MessagingProviderType  # noqa: PLC0415  # circular import
