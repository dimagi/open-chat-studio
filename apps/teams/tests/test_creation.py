...
def test_slug_generation_on_team_creation(db, client):
    """Test to verify tghat the slug is autogenerated when creating a team"""
    user = UserFactory()
...
def test_group_owner_assignment_on_team_creation(db, client):
