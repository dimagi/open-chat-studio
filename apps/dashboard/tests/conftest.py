...
def participant(team):
    ...
    return Participant.objects.create(
        ...
        identifier='test.participant@example.com',
        team=team,
        platform='web'
    )
...
def multiple_channels(team):
    ...
    for i, platform in enumerate(platforms):
        channel = ExperimentChannel.objects.create(
            name=f'Test {platform.title()} Channel',
            platform=platform,
            team=team
        )
        ...
        for part_idx, participant in enumerate(multiple_participants):
            ...
            for msg_idx in range(num_messages):
                ...
                message = ChatMessage.objects.create(
                    ...
                    content=f'Test message {msg_idx} in chat {exp_idx}-{part_idx}'
                )
