...
from apps.service_providers.llm_service.history_managers import AssistantPipelineHistoryManager, BaseHistoryManager
...
from apps.service_providers.llm_service.runnables import ChainOutput, GenerationCancelled, GenerationError
...
class ExperimentHistoryManager(BaseHistoryManager):
    ...
    @classmethod
    def for_assistant(cls, session: ExperimentSession, experiment: Experiment, trace_service):
