...
urlpatterns = [
    ...
    path("e/<int:experiment_id>/create-version/", views.CreateExperimentVersion.as_view(), name="create_version"),
    path("e/versions/default/<int:experiment_id>", views.set_default_experiment, name="update_default_experiment"),
