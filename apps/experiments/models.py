...
class Experiment(BaseTeamModel, VersionsMixin):
    ...
    def delete_experiment_channels(self):
        from apps.channels.models import (
            ExperimentChannel,  # noqa: PLC0415  # Circular: channels imports experiments.models
        )
    ...
    def get_assistant(self):
        ...
        from apps.assistants.models import (
            OpenAiAssistant,  # noqa: PLC0415  # Circular: assistants imports experiments.models
        )
        from apps.pipelines.models import Node  # noqa: PLC0415  # Circular: pipelines imports experiments.models
        from apps.pipelines.nodes.nodes import (
            AssistantNode,  # noqa: PLC0415  # Circular: nodes imports experiments.models
        )
...
class Participant(BaseTeamModel):
    ...
    def get_platform_display(self):
        from apps.channels.models import (
            ChannelPlatform,  # noqa: PLC0415  # Circular: channels imports experiments.models
        )
    ...
    def get_schedules_for_experiment(
        ...
        """
        from apps.events.models import ScheduledMessage  # noqa: PLC0415  # Circular: events imports experiments.models
...
class ExperimentSession(BaseTeamModel):
    ...
    def end(self, commit: bool = True, trigger_type=None):
        ...
        """
        from apps.events.models import StaticTriggerType  # noqa: PLC0415  # Circular: events imports experiments.models
        from apps.events.tasks import (
            enqueue_static_triggers,  # noqa: PLC0415  # Circular: events imports experiments.models
        )
    ...
    def try_send_message(self, message: str):
        ...
        from apps.chat.channels import (
            ChannelBase,  # noqa: PLC0415  # Circular: chat.channels imports experiments.models
        )
    ...
    def requires_participant_data(self) -> bool:
        ...
        from apps.pipelines.nodes.nodes import (  # noqa: PLC0415  # Circular: nodes imports experiments.models
            AssistantNode,
