...
class Experiment(BaseTeamModel, VersionsMixin):
    ...
    def delete_experiment_channels(self):
        from apps.channels.models import ExperimentChannel  # noqa: PLC0415 - avoid circular import
    ...
    def get_assistant(self):
        ...
        from apps.pipelines.models import Node  # noqa: PLC0415 - avoid circular import
        from apps.pipelines.nodes.nodes import AssistantNode  # noqa: PLC0415 - avoid circular import
...
class Participant(BaseTeamModel):
    ...
    def get_platform_display(self):
        from apps.channels.models import ChannelPlatform  # noqa: PLC0415 - avoid circular import
    ...
    def get_schedules_for_experiment(
        ...
        """
        from apps.events.models import ScheduledMessage  # noqa: PLC0415 - avoid circular import
...
class ExperimentSessionObjectManager(models.Manager):
    ...
    def get_table_queryset(self, team, experiment_id=None):
        from apps.annotations.models import CustomTaggedItem  # noqa: PLC0415 - avoid circular import
...
class ExperimentSession(BaseTeamModel):
    ...
    def end(self, commit: bool = True, trigger_type=None):
        ...
        """
        from apps.events.models import StaticTriggerType  # noqa: PLC0415 - avoid circular import
        from apps.events.tasks import enqueue_static_triggers  # noqa: PLC0415 - avoid circular import
    ...
    def _bot_prompt_for_user(
        ...
        """
        from apps.chat.bots import EventBot  # noqa: PLC0415 - avoid circular import
        from apps.service_providers.llm_service.history_managers import (
            ExperimentHistoryManager,  # noqa: PLC0415 - avoid circular import
        )
    ...
    def try_send_message(self, message: str):
        ...
        """
        from apps.chat.channels import ChannelBase  # noqa: PLC0415 - avoid circular import
    ...
    def requires_participant_data(self) -> bool:
        ...
        from apps.assistants.models import OpenAiAssistant  # noqa: PLC0415 - avoid circular import
        from apps.pipelines.nodes.nodes import (  # noqa: PLC0415 - avoid circular import
            AssistantNode,
