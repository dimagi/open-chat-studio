...
def build_system_agent(
    ...
    **kwargs,
    ...
    from langchain.agents import create_agent  # noqa: PLC0415  # lazy-loaded to keep Django startup fast
    from langchain.agents.middleware import (  # noqa: PLC0415  # lazy-loaded to keep Django startup fast
        ModelFallbackMiddleware,
        ModelRetryMiddleware,
    )

    from apps.service_providers.llm_service.retry import get_retry_middleware  # noqa: PLC0415  # lazy-loaded
