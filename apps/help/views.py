...
def code_completion(user_query, current_code, error=None, iteration_count=0) -> str:
    ...
    system_prompt = textwrap.dedent(
        ...
        def set_voice_output(key_name: str, data: Any) -> None:
            Sets the output voice provider and voice. Returns dict of voice name and is_default

        def get_voice_output(key_name: str, data: Any) -> dict | None:
            Returns dict of voice name and is_default. It returns None if voice does not exist.
        ```
