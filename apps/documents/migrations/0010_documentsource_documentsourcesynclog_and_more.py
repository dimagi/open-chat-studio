    ...
    operations = [
        migrations.CreateModel(
            ...
            fields=[
                ...
                ('auto_sync_enabled', models.BooleanField(default=False, help_text='Whether to automatically sync this source on a schedule')),
        ...
        migrations.AddConstraint(
            ...
            constraint=models.UniqueConstraint(fields=('team', 'collection'), name='unique_document_source_per_collection'),
        ),
    ]
