...
class Collection(BaseTeamModel, VersionsMixin):
    ...
    def create_new_version(self, save=True):  # ty: ignore[invalid-method-override]
        ...
        """
        from apps.documents.tasks import index_collection_files  # noqa: PLC0415  # circular: tasks imports models
    ...
    def archive(self):
        ...
        """
        from apps.documents.tasks import delete_collection_task  # noqa: PLC0415  # circular: tasks imports models
...
class DocumentSource(BaseTeamModel, VersionsMixin):
    ...
    def archive(self, delete_files=True):
        from apps.documents.tasks import delete_document_source_task  # noqa: PLC0415  # circular: tasks imports models
