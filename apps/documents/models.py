...
class Collection(BaseTeamModel, VersionsMixin):
    ...
    def archive(self):
        ...
        if self.is_remote_index and self.openai_vector_store_id:
            self._remove_remote_index(remote_files_to_remove=unused_files)
    ...
    def _remove_remote_index(self, remote_files_to_remove: list[File]):
        ...
        index_manager.delete_files(remote_files_to_remove)
