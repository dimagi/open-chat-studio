...
def _cleanup_old_vector_store(llm_provider_id: int, vector_store_id: str, file_ids: list[str]):
    import openai  # noqa: PLC0415 - lazy import for startup performance
...
def sync_document_source_task(document_source_id: int):
    ...
    from apps.documents.document_source_service import sync_document_source  # noqa: PLC0415 - avoid circular import
