...
class PipelineBot:
    ...
    def _run_pipeline(self, input_state, pipeline_to_use):
        from apps.experiments.models import AgentTools  # noqa: PLC0415 - avoid circular import
    ...
    def get_synthetic_voice(self) -> SyntheticVoice | None:
        from apps.experiments.models import SyntheticVoice  # noqa: PLC0415 - avoid circular import
...
class PipelineTestBot:
    ...
    def process_input(self, input: str) -> PipelineState:
        from apps.pipelines.graph import PipelineGraph  # noqa: PLC0415 - avoid circular import
        from apps.pipelines.nodes.helpers import temporary_session  # noqa: PLC0415 - avoid circular import
