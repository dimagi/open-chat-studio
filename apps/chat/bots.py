...
from apps.experiments.context import PromptTemplateContext
...
def get_bot(session: ExperimentSession, experiment: Experiment, trace_service, disable_tools: bool = False):
    """Get a bot instance for the given experiment session.

    All experiments are now pipeline-based.
    """
...
class EventBot:
    ...
    def system_prompt(self):
        context = PromptTemplateContext(self.session, self.experiment).get_context(
