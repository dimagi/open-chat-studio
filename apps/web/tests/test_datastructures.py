...
def test_column_filter_data():
    ...
    assert bool(ColumnFilterData(column=None, operator="equals", value="value")) is False
    assert bool(ColumnFilterData(column="test", operator=None, value="value")) is False
    assert bool(ColumnFilterData(column="test", operator="equals", value=None)) is False
