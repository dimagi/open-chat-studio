...
class AWSSpeechService(SpeechService):
    ...
    def _synthesize_voice(self, text: str, synthetic_voice: SyntheticVoice) -> SynthesizedAudio:
        ...
        from pydub import AudioSegment  # noqa: PLC0415 - lazy import for startup performance
...
class AzureSpeechService(SpeechService):
    ...
    def _synthesize_voice(self, text: str, synthetic_voice: SyntheticVoice) -> SynthesizedAudio:
        ...
        """
        import azure.cognitiveservices.speech as speechsdk  # noqa: PLC0415 - lazy import for startup performance
        from pydub import AudioSegment  # noqa: PLC0415 - lazy import for startup performance
...
class OpenAISpeechService(SpeechService):
    ...
    def _client(self) -> "OpenAI":
        from openai import OpenAI  # noqa: PLC0415 - lazy import for startup performance
