...
DEFAULT_LLM_PROVIDER_MODELS = {
    ...
    "anthropic": [
        ...
        Model("claude-3-sonnet-20240229", k(200)),
        Model("claude-3-haiku-20240307", k(200)),
    ...
    "groq": [
        ...
        Model("llama3-groq-70b-K(8)-tool-use-preview", k(8)),
        Model("llama3-groq-8b-K(8)-tool-use-preview", k(8)),
        Model("llama-3.1-70b-versatile,128k", k(8)),
        Model("llama-3.1-8b-instant,128k", k(8)),
        Model("llama-3.2-1b-preview,128k", k(8)),
        Model("llama-3.2-3b-preview,128k", k(8)),
        Model("llama-3.2-11b-vision-preview,128k", k(8)),
        Model("llama-3.2-90b-vision-preview,128k", k(8)),
        Model("llama-guard-3-8b", k(8)),
        Model("llama3-70b-K(8)", k(8)),
        Model("llama3-8b-K(8)", k(8)),
