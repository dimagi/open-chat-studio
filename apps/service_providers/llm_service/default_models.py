...
DEFAULT_LLM_PROVIDER_MODELS = {
    ...
    "openai": [
        ...
        Model("gpt-4.1", 1000000, is_translation_default=True, parameters=OpenAINonReasoningParameters),
        Model("gpt-4.1-mini", 1000000, is_default=True, parameters=OpenAINonReasoningParameters),
        Model("gpt-4.1-nano", 1000000, parameters=OpenAINonReasoningParameters),
        Model("o3", 128000, parameters=OpenAIReasoningParameters),
        Model("o3-mini", 128000, parameters=OpenAIReasoningParameters),
        Model("gpt-4o-mini", 128000, parameters=OpenAINonReasoningParameters),
        Model("gpt-4o", 128000, parameters=OpenAINonReasoningParameters),
        Model("chatgpt-4o-latest", 128000, parameters=OpenAINonReasoningParameters),
        Model("o1-preview", 128000, parameters=OpenAIReasoningParameters),
        Model("o1-mini", 128000, parameters=OpenAIReasoningParameters),
        Model("gpt-4", k(8), parameters=OpenAINonReasoningParameters),
        Model("gpt-4-turbo", 128000, parameters=OpenAINonReasoningParameters),
        Model("gpt-4-turbo-preview", 128000, parameters=OpenAINonReasoningParameters),
        Model("gpt-4-0125-preview", 128000, deprecated=True, parameters=OpenAINonReasoningParameters),
        Model("gpt-4-1106-preview", 128000, deprecated=True, parameters=OpenAINonReasoningParameters),
        Model("gpt-4-0613", k(8), deprecated=True, parameters=OpenAINonReasoningParameters),
        Model("gpt-3.5-turbo", k(16), parameters=OpenAINonReasoningParameters),
        Model("gpt-3.5-turbo-1106", k(16), parameters=OpenAINonReasoningParameters),
    ],
    "groq": [
