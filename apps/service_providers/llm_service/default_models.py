...
def get_default_translation_models_by_provider() -> dict:
    ...
    """
    from apps.service_providers.models import LlmProviderTypes  # noqa: PLC0415 - avoid circular import
...
def update_llm_provider_models():
    from apps.service_providers.models import LlmProviderModel  # noqa: PLC0415 - avoid circular import
...
def update_embedding_provider_models():
    from apps.service_providers.models import EmbeddingProviderModel  # noqa: PLC0415 - avoid circular import
