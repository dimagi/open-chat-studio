...
DEFAULT_LLM_PROVIDER_MODELS = {
    ...
    "deepseek": [
        ...
        # Experimental vision variant of deepseek-v4-flash: same 1M context, but its own rates
        # (see llm_pricing.json); images are tokenised by dimension and billed as input tokens.
