...
DEFAULT_LLM_PROVIDER_MODELS = {
    "azure": [
        ...
        Model("gpt-4.1", 1000000, is_translation_default=True, parameters=BasicParameters),
        Model("gpt-4.1-mini", 1000000, is_default=True, parameters=BasicParameters),
        Model("gpt-4.1-nano", 1000000, parameters=BasicParameters),
        Model("gpt-4o-mini", 128000, parameters=BasicParameters),
        Model("gpt-4o", 128000, parameters=BasicParameters),
        Model("gpt-4", k(8), deprecated=True),
        Model("gpt-4-32k", 32768, deprecated=True),
        Model("gpt-35-turbo", 16385, parameters=BasicParameters),
    ...
    "openai": [
        ...
        Model("gpt-4o-mini", 128000, parameters=BasicParameters),
        Model("gpt-4o", 128000, parameters=BasicParameters),
        Model("chatgpt-4o-latest", 128000, parameters=BasicParameters),
        Model("o1-preview", 128000, deprecated=True),
        Model("o1-mini", 128000, deprecated=True),
        Model("gpt-4", k(8), parameters=BasicParameters),
        Model("gpt-4-turbo", 128000, parameters=BasicParameters),
        Model("gpt-4-turbo-preview", 128000, parameters=BasicParameters),
        ...
        Model("gpt-3.5-turbo", k(16), parameters=BasicParameters),
        Model("gpt-3.5-turbo-1106", k(16), parameters=BasicParameters),
    ...
    "groq": [
        Model("whisper-large-v3", k(8), parameters=BasicParameters),
        Model("whisper-large-v3-turbo", k(8), parameters=BasicParameters),
        Model("gemma2-9b-it", k(8), parameters=BasicParameters),
        ...
        Model(
            "llama-3.1-70b-versatile", k(128), is_default=True, is_translation_default=True, parameters=BasicParameters
        ),
        Model("llama-3.1-8b-instant", k(128), parameters=BasicParameters),
        ...
        Model("llama-guard-3-8b", k(8), parameters=BasicParameters),
        Model("llama3-70b-8192", k(8), parameters=BasicParameters),
        Model("llama3-8b-8192", k(8), parameters=BasicParameters),
        Model("mixtral-8x7b-32768", 32768, parameters=BasicParameters),
    ],
    "perplexity": [
        Model("sonar", 128000, is_default=True, parameters=BasicParameters),
        Model("sonar-pro", 200000, parameters=BasicParameters),
        Model("sonar-reasoning", 128000, is_translation_default=True, parameters=BasicParameters),
        Model("sonar-reasoning-pro", 128000, parameters=BasicParameters),
        Model("sonar-deep-research", 128000, parameters=BasicParameters),
        ...
        Model("llama-3.1-sonar-small-128k-chat", 127072, parameters=BasicParameters),
        Model("llama-3.1-sonar-large-128k-chat", 127072, parameters=BasicParameters),
        Model("llama-3.1-8b-instruct", 131072, parameters=BasicParameters),
        Model("llama-3.1-70b-instruct", 131072, parameters=BasicParameters),
    ],
    "deepseek": [
        Model("deepseek-chat", 128000, is_default=True, parameters=BasicParameters),
        Model("deepseek-reasoner", 128000, is_translation_default=True, parameters=BasicParameters),
    ],
    "google": [
        Model("gemini-2.5-flash", 1048576, is_default=True, parameters=BasicParameters),
        Model("gemini-2.5-pro", 1048576, is_translation_default=True, parameters=BasicParameters),
        Model("gemini-2.0-flash", 1048576, parameters=BasicParameters),
        Model("gemini-1.5-flash", 1048576, parameters=BasicParameters),
        Model("gemini-1.5-flash-8b", 1048576, parameters=BasicParameters),
        Model("gemini-1.5-pro", 2097152, parameters=BasicParameters),
    ],
}
