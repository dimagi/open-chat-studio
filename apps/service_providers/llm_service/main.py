...
class OpenAIGenericService(LlmService):
    ...
    def get_chat_model(self, llm_model: str, **kwargs) -> BaseChatModel:
        from langchain_openai.chat_models import ChatOpenAI  # noqa: PLC0415  # lazy-loaded heavy library (TID253)
...
class OpenAILlmService(OpenAIGenericService):
    ...
    def get_assistant(self, assistant_id: str, as_agent=False):
        from apps.service_providers.llm_service.openai_assistant import (  # noqa: PLC0415  # lazy load
    ...
    def get_remote_index_manager(self, index_id: str | None = None) -> IndexManager:
        from apps.service_providers.llm_service.index_managers import (  # noqa: PLC0415  # lazy load
...
class AzureLlmService(LlmService):
    ...
    def get_chat_model(self, llm_model: str, **kwargs) -> BaseChatModel:
        from langchain_openai.chat_models import AzureChatOpenAI  # noqa: PLC0415  # lazy-loaded heavy library (TID253)
...
class AnthropicLlmService(LlmService):
    ...
    def get_chat_model(self, llm_model: str, **kwargs) -> BaseChatModel:
        from langchain_anthropic import ChatAnthropic  # noqa: PLC0415  # lazy-loaded heavy library (TID253)
...
class GoogleLlmService(LlmService):
    ...
    def get_chat_model(self, llm_model: str, **kwargs) -> BaseChatModel:
        from langchain_google_genai import ChatGoogleGenerativeAI  # noqa: PLC0415  # lazy-loaded heavy library (TID253)
...
class GoogleVertexAILlmService(LlmService):
    ...
    def get_chat_model(self, llm_model: str, **kwargs) -> BaseChatModel:
        from langchain_google_vertexai import ChatVertexAI  # noqa: PLC0415  # lazy-loaded heavy library (TID253)
    ...
    def credentials(self):
        from google.oauth2 import service_account  # noqa: PLC0415  # lazy-loaded provider SDK
