...
# Lazily created OpenAIAssistantRunnable class to avoid heavy import at module level
_OpenAIAssistantRunnable = None


def _get_openai_assistant_runnable_class():
    """Lazily create and cache the OpenAIAssistantRunnable class."""
    global _OpenAIAssistantRunnable
    if _OpenAIAssistantRunnable is not None:
        return _OpenAIAssistantRunnable
    ...
    _OpenAIAssistantRunnable = OpenAIAssistantRunnable
    return _OpenAIAssistantRunnable


# Public accessor for OpenAIAssistantRunnable
def OpenAIAssistantRunnable(*args, **kwargs):
    """Factory function to create OpenAIAssistantRunnable instances."""
    cls = _get_openai_assistant_runnable_class()
