...
class OpenAIGenericService(LlmService):
    ...
    def get_chat_model(self, llm_model: str, **kwargs) -> BaseChatModel:
        from langchain_openai.chat_models import ChatOpenAI  # noqa: PLC0415  # TID253: heavy lib
...
class OpenAILlmService(OpenAIGenericService):
    ...
    def get_assistant(self, assistant_id: str, as_agent=False):
        from apps.service_providers.llm_service.openai_assistant import (  # noqa: PLC0415  # loads langchain_classic at module level
...
class AzureLlmService(LlmService):
    ...
    def get_chat_model(self, llm_model: str, **kwargs) -> BaseChatModel:
        from langchain_openai.chat_models import AzureChatOpenAI  # noqa: PLC0415  # TID253: heavy lib
...
class AnthropicLlmService(LlmService):
    ...
    def get_chat_model(self, llm_model: str, **kwargs) -> BaseChatModel:
        from langchain_anthropic import ChatAnthropic  # noqa: PLC0415  # TID253: heavy lib
...
class GoogleLlmService(LlmService):
    ...
    def get_chat_model(self, llm_model: str, **kwargs) -> BaseChatModel:
        from langchain_google_genai import ChatGoogleGenerativeAI  # noqa: PLC0415  # TID253: heavy lib
...
class GoogleVertexAILlmService(LlmService):
    ...
    def get_chat_model(self, llm_model: str, **kwargs) -> BaseChatModel:
        from langchain_google_vertexai import ChatVertexAI  # noqa: PLC0415  # TID253: heavy lib
