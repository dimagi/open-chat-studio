# This file contains generic/reusable LLM service components used by pipelines.
# All experiment-specific runnables have been removed since experiments now use pipelines exclusively.
...
class AssistantChat(RunnableSerializable[dict, ChainOutput]):
    """Assistant chat implementation used by AssistantNode in pipelines."""
...
class AgentAssistantChat(AssistantChat):
    """Agent-enabled assistant chat implementation used by AssistantNode in pipelines."""
