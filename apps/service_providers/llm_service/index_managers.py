...
class OpenAILocalIndexManager(LocalIndexManager):
    ...
    def get_embedding_vector(self, content: str) -> Vector:
        from langchain_openai import OpenAIEmbeddings  # noqa: PLC0415  # lazy-loaded heavy library (TID253)
...
class GoogleLocalIndexManager(LocalIndexManager):
    def get_embedding_vector(self, content: str) -> Vector:
        from langchain_google_genai import (  # noqa: PLC0415  # lazy-loaded heavy library (TID253)
