...
class OpenAIRemoteIndexManager(RemoteIndexManager):
    ...
    def upload_file_to_remote(self, file: File):
        from apps.assistants.sync import create_files_remote  # noqa: PLC0415 - avoid circular import
...
class OpenAILocalIndexManager(LocalIndexManager):
    ...
    def get_embedding_vector(self, content: str) -> Vector:
        from langchain_openai import OpenAIEmbeddings  # noqa: PLC0415 - lazy import for startup performance
...
class GoogleLocalIndexManager(LocalIndexManager):
    def get_embedding_vector(self, content: str) -> Vector:
        from langchain_google_genai import (
            GoogleGenerativeAIEmbeddings,  # noqa: PLC0415 - lazy import for startup performance
        )
