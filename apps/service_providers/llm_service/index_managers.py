...
class OpenAILocalIndexManager(LocalIndexManager):
    ...
    def get_embedding_vector(self, content: str) -> Vector:
        from langchain_openai import OpenAIEmbeddings  # noqa: PLC0415  # TID253: heavy lib
...
class GoogleLocalIndexManager(LocalIndexManager):
    def get_embedding_vector(self, content: str) -> Vector:
        from langchain_google_genai import GoogleGenerativeAIEmbeddings  # noqa: PLC0415  # TID253: heavy lib
