...
class BaseAdapter:
    ...
    def get_callable_tools(self):
        ...
        """
        from google.ai.generativelanguage_v1beta.types import (  # noqa: PLC0415  # avoid circular import
            Tool as GenAITool,
        )
...
class AssistantAdapter(BaseAdapter):
    def __init__(
        ...
        from apps.chat.agent.tools import get_assistant_tools  # noqa: PLC0415  # avoid circular import
