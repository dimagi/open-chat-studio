...
urlpatterns = [
    ...
    path("scheduled/new/", views.create_scheduled_event_view, name="scheduled_event_new"),
    ...
    path("scheduled/<int:trigger_id>", views.edit_scheduled_event_view, name="scheduled_event_edit"),
    ...
    path("scheduled/<int:trigger_id>/delete", views.delete_scheduled_event_view, name="scheduled_event_delete"),
    ...
    path("scheduled/<int:trigger_id>/logs", views.scheduled_logs_view, name="scheduled_logs_view"),
    ...
    path(
        "scheduled/<int:trigger_id>/toggle-active",
        views.toggle_scheduled_active_status,
        name="scheduled_event_toggle",
    ),
