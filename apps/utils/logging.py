...
class ContextVarFilter(logging.Filter):
    ...
    def filter(self, record):
        from apps.audit.transaction import (
            get_audit_transaction_id,  # noqa: PLC0415 - lazy import for startup performance
        )
        from apps.teams.utils import get_current_team  # noqa: PLC0415 - lazy import for startup performance
