...
def get_next_unique_slug(model_class: Model, input_value: str, field_name: str, model_instance=None) -> str:
    """
...
def get_next_unique_id(model_class: Model, inputs: list, field_name: str, length=8, model_instance=None) -> str:
    """
