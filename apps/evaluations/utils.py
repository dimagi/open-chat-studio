...
def get_evaluator_type_info() -> dict[str, dict[str, str | None]]:
    ...
    """
    from apps.evaluations import evaluators  # noqa: PLC0415 - avoid circular import
...
def get_evaluators_with_schema(team) -> list[dict]:
    ...
    """
    from apps.evaluations.models import Evaluator  # noqa: PLC0415 - avoid circular import
...
def make_evaluation_messages_from_sessions(message_ids_per_session: dict[str, list[str]]) -> list["EvaluationMessage"]:
    from apps.evaluations.models import EvaluationMessage, EvaluationMessageContent  # noqa: PLC0415 - avoid circular import
