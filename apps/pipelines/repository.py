...
class InMemoryPipelineRepository(ORMRepository):
    ...
    def get_pipeline_chat_history(self, history_type, name):
        ...
        if key not in self.chat_histories:
            from apps.utils.factories.pipelines import (
                PipelineChatHistoryFactory,  # noqa: PLC0415  # Test factory; inline to avoid test deps in production
            )
    ...
    def save_pipeline_chat_message(self, history, human_message, ai_message, node_id):
        ...
        from apps.utils.factories.pipelines import (
            PipelineChatMessagesFactory,  # noqa: PLC0415  # Test factory; inline to avoid test deps in production
        )
    ...
    def create_file(self, filename, file_obj, content_type, purpose):
        ...
        from apps.utils.factories.files import (
            FileFactory,  # noqa: PLC0415  # Test factory; inline to avoid test deps in production
        )
