...
class InMemoryPipelineRepository(ORMRepository):
    ...
    def get_pipeline_chat_history(self, history_type, name):
        ...
        if key not in self.chat_histories:
            from apps.utils.factories.pipelines import (  # noqa: PLC0415  # avoid circular import
    ...
    def save_pipeline_chat_message(self, history, human_message, ai_message, node_id):
        ...
        from apps.utils.factories.pipelines import PipelineChatMessagesFactory  # noqa: PLC0415  # avoid circular import
    ...
    def create_file(self, filename, file_obj, content_type, purpose):
        ...
        from apps.utils.factories.files import FileFactory  # noqa: PLC0415  # avoid circular import
