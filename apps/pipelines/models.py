...
class NodeObjectManager(VersionsObjectManagerMixin, models.Manager):
    def llm_response_with_prompt_nodes(self):
        from apps.pipelines.nodes.nodes import LLMResponseWithPrompt  # noqa: PLC0415  # circular import
...
class Pipeline(BaseTeamModel, VersionsMixin):
    ...
    def validate(self, full=True) -> dict:
        ...
        from apps.pipelines.graph import PipelineGraph  # noqa: PLC0415  # circular import
        from apps.pipelines.nodes import nodes as pipeline_nodes  # noqa: PLC0415  # circular import
...
class Node(BaseModel, VersionsMixin, CustomActionOperationMixin):
    ...
    def create_new_version(self, is_copy=False, new_flow_id=None):  # ty: ignore[invalid-method-override]
        ...
        from apps.pipelines.nodes.nodes import AssistantNode, LLMResponseWithPrompt  # noqa: PLC0415  # circular import
    ...
    def _archive_related_params(self):
        ...
        """
        from apps.assistants.models import OpenAiAssistant  # noqa: PLC0415  # circular import
        from apps.pipelines.nodes import nodes  # noqa: PLC0415  # circular import
