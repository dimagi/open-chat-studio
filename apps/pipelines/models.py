...
class NodeObjectManager(VersionsObjectManagerMixin, models.Manager):
    def llm_response_with_prompt_nodes(self):
        from apps.pipelines.nodes.nodes import LLMResponseWithPrompt  # noqa: PLC0415  # Circular: nodes imports models

        return self.get_queryset().filter(type=LLMResponseWithPrompt.__name__)

    def assistant_nodes(self):
        from apps.pipelines.nodes.nodes import AssistantNode  # noqa: PLC0415  # Circular: nodes imports models
...
class Pipeline(BaseTeamModel, VersionsMixin):
    ...
    def validate(self, full=True) -> dict:
        ...
        from apps.pipelines.graph import PipelineGraph  # noqa: PLC0415  # Circular: graph imports models
        from apps.pipelines.nodes import nodes as pipeline_nodes  # noqa: PLC0415  # Circular: nodes imports models
...
class Node(BaseModel, VersionsMixin, CustomActionOperationMixin):
    ...
    def create_new_version(self, is_copy=False, new_flow_id=None):  # ty: ignore[invalid-method-override]
        ...
        """
        from apps.assistants.models import OpenAiAssistant  # noqa: PLC0415  # Circular: assistants imports models
        from apps.pipelines.nodes.nodes import (  # noqa: PLC0415  # Circular: nodes imports models
            AssistantNode,
    ...
    def _archive_related_params(self):
        ...
        """
        from apps.assistants.models import OpenAiAssistant  # noqa: PLC0415  # Circular: assistants imports models
        from apps.pipelines.nodes import nodes  # noqa: PLC0415  # Circular: nodes imports models
