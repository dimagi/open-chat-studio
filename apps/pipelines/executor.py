...
from langchain_core.runnables import config as langchain_runnables_config
...
def patch_executor(executor: type[Executor]) -> Generator[None, Any]:
    ...
    original = langchain_runnables_config.ContextThreadPoolExecutor
    langchain_runnables_config.ContextThreadPoolExecutor = executor  # ty: ignore[invalid-assignment]
    try:
        yield
    finally:
        langchain_runnables_config.ContextThreadPoolExecutor = original
