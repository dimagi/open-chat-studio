...
from apps.service_providers.utils import get_first_llm_provider, get_first_llm_provider_model
...
class ChatbotForm(forms.ModelForm):
    ...
    def save(self, commit=True):
        llm_provider = get_first_llm_provider()
        llm_provider_model = None
        if llm_provider:
            llm_provider_model = get_first_llm_provider_model(llm_provider)
