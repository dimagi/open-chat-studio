...
export default function Component({label, onClick, onDragStart, parentRef, hasHelp, toggleHelp}: ComponentProps) {
  return (
    <div
      ...
      className="relative my-2 px-4 py-2 shadow-xs rounded-md border-2 border-stone-300 bg-base-100 hover:cursor-pointer hover:bg-slate-200 dark:hover:bg-opacity-20"
    >
