...
export function PipelineNode({ id, data, selected }: NodeProps<NodeData>) {
  ...
  const handlesFactory = getOutputFactory(data.type);
...
const getInputWidget = ({id, inputParam, params, setParams, updateParamValue}: InputWidgetParams) => {
